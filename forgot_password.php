<?php
/**
 * /login/forgot_password.php — Password request form
 *
...
<body>
    ...
    <div class="card" role="main">
        ...
        <?php if ($success): ?>
            ...
            <a href="/login/index.php" class="btn-secondary" style="display:flex;margin-top:8px;">
                &larr; <?= t('btn_back') ?>
            </a>
        ...
        <?php else: ?>
            ...
            <form method="POST" action="/login/forgot_password.php" novalidate>
                <?= csrfField() ?>
                ...
                <div style="margin-top:14px; text-align:center;">
                    <a href="/login/index.php" class="card-footer-link">
                        &larr; <?= t('btn_back') ?>
                    </a>
                </div>
            </form>
