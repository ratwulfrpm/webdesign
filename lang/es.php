...
return [
    ...
    'switch_org'           => 'Cambiar organización',
    ...
    'inv_admin_orgs_label'      => 'Asignar a organizaciones',
    'inv_admin_orgs_help'       => 'Seleccione las organizaciones a las que este administrador tendrá acceso. Debe elegir al menos una.',
    'inv_err_no_org_selected'   => 'Seleccione al menos una organización.',
    'inv_col_orgs'              => 'Organizaciones',
    ...
    'enroll_subtitle_staff'     => 'Complete el formulario para activar su cuenta.',
    ...
    'all_products_subtitle_admin'  => 'Mostrando productos de tus unidades de negocio asignadas:',
    ...
    'btn_request_contract_review'    => 'Solicitar revisión de vigencia',
    ...
    'contract_history_requires_review' => 'Este contrato pertenece al historial y requiere revisión administrativa para modificar la vigencia.',
    'contract_history_expired_warning' => 'Este contrato pertenece al historial y puede requerir revisión administrativa antes de modificar la vigencia.',
    'contract_review_request_sent'   => 'Su solicitud fue enviada al administrador para revisión. El contrato vigente no cambiará hasta ser aprobado.',
    'contract_review_request_pending_exists' => 'Ya existe una solicitud pendiente para este contrato.',
    'contract_review_request_latest_not_needed' => 'Este es el contrato más reciente; puede marcarse como vigente sin solicitud de revisión.',
    'contract_review_requests_title' => 'Solicitudes de revisión de vigencia de contratos',
    'contract_review_no_requests'    => 'No hay solicitudes de revisión de vigencia.',
    'contract_review_business_unit'  => 'Unidad de negocio',
    'contract_review_requested_contract' => 'Contrato solicitado',
    'contract_review_current_contract' => 'Contrato vigente actual',
    'contract_review_requested_by'   => 'Solicitado por',
    'contract_review_requested_at'   => 'Fecha de solicitud',
    'contract_review_comment_optional' => 'Comentario opcional',
    'contract_review_approved'       => 'Solicitud aprobada. El contrato solicitado ahora está vigente.',
    'contract_review_rejected'       => 'Solicitud rechazada. El contrato vigente no cambió.',
    'contract_review_action_failed'  => 'No se pudo procesar la solicitud. Verifique estado y permisos.',
    'contract_review_status_pending' => 'Pendiente',
    'contract_review_status_approved' => 'Aprobada',
    'contract_review_status_rejected' => 'Rechazada',
    'contract_review_status_cancelled' => 'Cancelada',
    ...
    'asgn_link_share_title'            => 'Compártelo de forma rápida por QR, correo o WhatsApp.',
    'asgn_link_qr_label'               => 'Escanea este QR para abrir la cotización',
    'asgn_link_email_placeholder'      => 'Correo destino para enviar QR',
    'asgn_link_send_email_btn'         => 'Enviar QR por correo',
    'asgn_link_send_whatsapp_btn'      => 'Enviar por WhatsApp',
    'asgn_link_whatsapp_template'      => "Cotización para %s\n\nAbrir link:\n%s\n\nQR:\n%s",
    'asgn_link_mail_sent'              => 'Correo enviado correctamente con el link y QR.',
    'asgn_link_mail_logged'            => 'No se pudo enviar por SMTP; se guardó en logs/mail.log.',
    'asgn_link_mail_error'             => 'No se pudo enviar el correo con QR.',
    'asgn_link_err_invalid_email'      => 'Correo inválido para compartir el QR.',
    ...
    'asgn_btn_regen'                   => 'Replicar cotización',
    ...
    'asgn_regen_modal_title'           => 'Replicar cotización',
    'asgn_regen_customer_label'        => 'Nombre del cliente',
    'asgn_regen_customer_ph'           => 'Nombre del cliente...',
    'asgn_regen_company_label'         => 'Empresa (opcional)',
    'asgn_regen_company_ph'            => 'Nombre de empresa...',
    'asgn_regen_conditions_label'      => 'Condiciones especiales (opcional)',
    'asgn_regen_conditions_ph'         => 'Ej. Pago 30 días, envío incluido...',
    'asgn_regen_conditions_hint'       => 'Pre-cargado del original. Puede editarse antes de generar.',
    'asgn_regen_submit'                => 'Replicar cotización',
    'asgn_regen_cancel'                => 'Cancelar',
    'asgn_revoked_success'             => 'Acceso revocado correctamente.',
    'asgn_deleted_success'             => 'Cotización eliminada.',
    'asgn_regen_success'               => 'Cotización replicada exitosamente.',
    ...
    'asgn_transport_percentage_label'  => 'Transporte %',
    'asgn_transport_percentage_ph'     => '0 a 100',
    'asgn_transport_amount_label'      => 'Monto de transporte',
    'asgn_transport_amount_ph'         => '0.00',
    'asgn_tax_percentage_label'        => 'Impuesto %',
    'asgn_tax_percentage_ph'           => '0 a 100',
    'asgn_tax_amount_label'            => 'Monto de impuesto',
    'asgn_tax_amount_ph'               => '0.00',
    'asgn_validity_amount_label'       => 'Duración',
    'asgn_validity_amount_ph'          => 'Número',
    'asgn_validity_unit_hours'         => 'Horas',
    'asgn_validity_unit_days'          => 'Días',
    'asgn_validity_help'               => 'Máximo 7 días (168 horas)',
    ...
    'asgn_err_profit_required'         => 'Se requiere configuración de ganancia.',
    'asgn_max_visits_label'            => 'Máximo número de visitas al enlace (opcional)',
    'asgn_max_visits_ph'               => 'p.ej. 5, 10, ilimitado si está vacío',
    'asgn_max_visits_help'             => 'Una vez alcanzado, el enlace dejará de funcionar. Dejar vacío para vistas ilimitadas.',
    ...
    'quote_transport_label'            => 'Transporte',
    'quote_tax_label'                  => 'Impuesto',
    'quote_include_in_quote'           => 'Incluir en cotización',
    'quote_no_items_selected'          => 'Ningún producto seleccionado.',

    'quote_cart_label'                 => 'Carrito',
    'quote_cart_select_label'          => 'Seleccionar artículos',
    'quote_cart_item_count'            => 'Artículo(s): %d',
    'quote_cart_subtotal_label'        => 'Subtotal',
    'quote_cart_transport_label'       => 'Transporte',
    'quote_cart_tax_label'             => 'Impuesto',
    'quote_cart_discount_label'        => 'Descuento',
    'quote_cart_total_label'           => 'Total',
    'quote_btn_payment'                => 'Proceder al Pago',
    'quote_payment_disabled_note'      => 'La funcionalidad de pago estará disponible pronto.',
    ...
    'bu_list_title'                => 'Todas las Unidades de Negocio',
    'bu_count_label'               => 'total',
    'bu_no_units'                  => 'No hay unidades de negocio registradas.',
    'bu_field_name'                => 'Nombre',
    'bu_field_name_ph'             => 'Ej. División Retail',
    'bu_field_slug'                => 'Slug (identificador único)',
    'bu_field_slug_ph'             => 'Ej. division-retail',
    'bu_field_slug_hint'           => 'Solo letras minúsculas, números y guiones.',
    'bu_field_description'         => 'Descripción',
    'bu_field_description_ph'      => 'Descripción breve (opcional)',
    'bu_btn_create'                => 'Crear Unidad de Negocio',
    'bu_members_label'             => 'Miembros',
    'bu_created_label'             => 'Creada',
    'bu_admins_label'              => 'Administradores',
    'bu_no_admins'                 => 'Sin administradores asignados.',
    'bu_select_admin'              => '— Seleccionar usuario —',
    'bu_btn_assign'                => 'Asignar',
    'bu_btn_remove_admin'          => 'Quitar admin',
    'bu_confirm_remove_admin'      => '¿Quitar este administrador de la unidad de negocio?',
    'bu_feedback_created'          => 'Unidad de negocio "%s" creada correctamente.',
    'bu_feedback_saved'            => 'Cambios guardados.',
    'bu_feedback_activated'        => 'Unidad de negocio activada.',
    'bu_feedback_deactivated'      => 'Unidad de negocio desactivada.',
    'bu_feedback_admin_assigned'   => 'Administrador asignado correctamente.',
    'bu_feedback_admin_removed'    => 'Administrador eliminado.',
    'bu_error_name_slug_required'  => 'El nombre y el slug son obligatorios.',
    'bu_error_slug_taken'          => 'El slug "%s" ya está en uso. Elija otro.',
    'bu_error_save_failed'         => 'Error al guardar. Intente de nuevo.',
