...
<body class="wide-layout role-<?= htmlspecialchars($_SESSION['role'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
    ...
    <div class="page-content">
        ...
        <!-- ⚠ DEV-ONLY BLOCK — Temporary password display (never shown in production) ─
             This block is only rendered in APP_ENV=dev when email credentials are placeholder values.
             Remove or disable MAIL_USER / MAIL_PASS placeholders, or set APP_ENV=prod, to suppress this. -->
        ...
        <?php
        $actionUrl = '/login/admin/users.php';
        ...
        <section class="panel-section" style="margin-top:36px;" id="invitations">
            ...
            <div style="margin-top:32px;">
                ...
                <?php
                $actionUrl = '/login/admin/users.php#invitations';
                $isOwner   = false;
